...
export var copyByteArray = function (
...
export class ProtocolBase {
  public owner: Network | null = null;
...
export class PackageBase {
  ...
  public getPckType(pck: any) {
    return pck.type;
  }

  public getPckBody(pck: any) {
    return pck.body;
  }
  ...
  public encode(type: number, body: Uint8Array | null = null): Uint8Array {
...
export class MessageBase {
  ...
  public encodeMsgId(id: number, buffer: any, offset: number) {
    do {
      var tmp = id % 128;
  ...
  public msgHasRoute(type: number) {
    return (
      ...
      type === this.TYPE_NOTIFY ||
      type === this.TYPE_PUSH
    );
  }

  public encodeMsgFlag(
    type: number,
    ...
    if (
      ...
      throw new Error(
        "MessageBase.encodeMsgFlag: unkonw message type = " + type
      );
    }
  ...
  public encodeMsgBody(msg: any, buffer: any, offset: any) {
    copyByteArray(buffer, offset, msg, 0, msg.length);
    return offset + msg.length;
  }

  public encodeMsgRoute(
    compressRoute: any,
    route: any,
    buffer: any,
    offset: any
